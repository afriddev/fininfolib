export default function LetsTalk(){
    ...
    <div className=" flex flex-col ">
          <div className="flex flex-col m-4 space-y-4">
            <h2 className="text-2xl ">We have handpicked developers ready to work for your projects</h2>
        ...
        <div className="flex flex-col m-4 mt-6">
          <div className ="flex flex-col justify-start items-start  space-y-4 ">
            <div className="flex flex-col w-full">
              <label className="font-bold">Full name <span className="text-red-700 text-xl">*</span></label>
              <input type="text" placeholder="Enter your name" className=" p-2 outline-none border-b border-gray-600 justify-start
            w-5/6 ml-4"/>
            </div>
            <div className="flex flex-col w-full">
              <label className="font-bold">Email <span className="text-red-700 text-xl">*</span></label>
              <input type="text" placeholder="Enter your email" className="p-2 outline-none border-b border-gray-600 justify-start
            w-5/6 ml-4"/>
            </div>
            <div className="flex flex-col w-full">
              <label className="font-bold">Message <span className="text-red-700 text-xl">*</span></label>

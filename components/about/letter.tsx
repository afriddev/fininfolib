...
const Letter = () => {
    ...
    return (
        <>
            <section>
                <div ref={ref} className="bg-bg2 m-2  h-fit relative lg:justify-center lg:items-center lg:mt-20 lg:mb-20 lg:ml-32 lg:mr-32">
                    ...
                    <div className="lg:pl-[5%] lg:pr-[5%] lg:gap-y-8 lg:justify-center
                     lg:items-center">
                        ...
                        }} className="pl-4 pr-4 pt-8 text-xl font-bold text-pH text-center pb-4 lg:text-4xl lg:text-center ">
                        ...
                        }} className="pl-5 pt-2  text-gray-700 text-center pr-5 text-sm lg:text-lg">Through years of hard work, we have earned a reputation for top-tier services.
                        ...
                        }} className="pl-5 pt-6 pb-6 text-gray-700 text-center pr-5 text-sm lg:text-lg lg:pb-12">

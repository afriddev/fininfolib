    ...
    return (
        <>
            <div className="text-gray-700">
                ...
                from-o1 to-o2 items-center">
                    <label className="flex text-2xl text-white font-bold pl-3 py-4 ">
                        Terms & Conditions </label>
                </div>
                <div className=" flex m-2 bg-bg2 h-fit p-4 flex-col  ">
                    <h2 className="pt-3 text-xl font-bold text-primaryGreen">
                        Terms & Conditions</h2>
                    ...
                    <div className="flex flex-col pt-6 ">
                        <ul className="flex flex-col pt-6 pl-8 pr-4 list-disc space-y-4 text-sm ">
                    ...
                    <div className="flex flex-col pt-6 space-y-6">
                        <div>
                            <h3 className="font-bold text-md text-gray-700">HOSTING PACKAGE : </h3>
                        ...
                        <div>
                            <h3 className="font-bold text-md text-gray-700">CURRENCIES : </h3>
                            <p className="pt-2 text-sm ">
                        ...
                        <div>
                            <h3 className="font-bold text-md text-gray-700">PAYMENT QUERIES : </h3>
                            <p className="pt-2 text-sm ">
                        ...
                        <div>
                            <h3 className="font-bold text-md text-gray-700">REFUND POLICY : </h3>
                            <p className="pt-2 text-sm ">
                        ...
                        <div>
                            ...
                            <h3 className="font-bold text-md text-gray-700">CANCELLATION POLICY : </h3>
                            <p className="pt-2 text-sm ">

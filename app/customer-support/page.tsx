    ...
    return(
        <>
            <div>
                ...
                p-6 ">
                    <h1 className="text-white font-bold text-xl text-center">Tele services Fully Managed for 
                        Sales / Customer / Technical support and Operations Teams.</h1>
                        <p className="text-sm text-gray-200 p-4">
                ...
                <div className="p-6 mt-4">
                    ...
                    <p className="pt-4 tetx-md text-gray-700" >
